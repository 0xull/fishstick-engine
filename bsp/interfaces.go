...
type Aggregator interface {
	...
	// Delta return the change in the aggregator's value since the 
	// last call to Delta. The delta values can be used in distributed
	// aggregator use-cases to reduce local, partially-aggregated values
	// into a singe value across by feeding them into the Aggregate method
...
// Relayers. If it is a function with the appropriate signature,

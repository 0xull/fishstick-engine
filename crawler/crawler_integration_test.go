...
import (
	...
	"github.com/IkehAkinyemi/fishstick-engine/crawler"
	"github.com/IkehAkinyemi/fishstick-engine/crawler/privnet"
	"github.com/IkehAkinyemi/fishstick-engine/linkgraph/graph"
	memgraph "github.com/IkehAkinyemi/fishstick-engine/linkgraph/store/inmemory"
	"github.com/IkehAkinyemi/fishstick-engine/textindexer/index"
	memidx "github.com/IkehAkinyemi/fishstick-engine/textindexer/store/inmemory"
...
var (
	...
	<html>
		...
		<body>
			...
			<a href="//images/cart.png">I am using the same URL schem as this page</a>
			
			<!-- Link should be added to the index but without creating an edge to it -->
			<a href="ignore-me" rel="nofollow"/>
			
			<!-- The following lins should be ignored -->
...
func mustCreatePrivateNetworkDetector(c *gc.C) *privnet.Detector {
	// Use a custome CIDR list to temporarily allow calls to the HTTP servers

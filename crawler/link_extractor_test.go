...
var (
	_ = gc.Suite(new(ResolvedURLTestSuite))
	_ = gc.Suite(new(LinkExtractorTestSuite))
)

type ResolvedURLTestSuite struct {}

func (s *ResolvedURLTestSuite) TestResolveAbsoluteURL(c *gc.C) {
	assertResolvedURL(c,
		"/bar/baz",
...
func (s *ResolvedURLTestSuite) TestRelativeURL(c *gc.C) {
	assertResolvedURL(c,
		"bar/baz",
		"http://example.com/foo/",
...
func (s *ResolvedURLTestSuite) TestResolvedDoubleSlashURL(c *gc.C) {
	assertResolvedURL(c,
...
func (s *LinkExtractorTestSuite) TestLinkExtractor(c *gc.C) {
	...
	s.assertExtractedLinks(c, "http//text.com", content, []string{
		"https://example.com",
		"http://foo.com",
...
func (s *LinkExtractorTestSuite) TestLinkExtractorWithRelativeLinksToDir(c *gc.C) {
	...
	s.assertExtractedLinks(c, "https://test.com/content/", content, []string{
		"https://text.com/content/foo.html",
		"https://test.com/private/data.html",
	}, nil)
}
...
func(s *LinkExtractorTestSuite) TestLinkExtractorWithPrivateNetworkLinks(c *gc.C) {
	...
	<html>
		<body>
			...
			<a href="https://169.254.169.254/api/credentials"/>
		</body>
	</html>
	`

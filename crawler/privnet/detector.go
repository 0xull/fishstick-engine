...
// Detector checks if a host name resolves to a private network address.
type Detector struct {
	privBlocks []*net.IPNet
}

// NewDetector returns a Detector instance that is initialized with the
...
// NewDetectorFromCIDRs returns a Detector instance initialised
// with specified list of private network CIDRs.
